    ...
    const languages = {
                ko: {
                    ...
                    // 에러 메시지들
                    invalid_bbc_url: "올바른 BBC 뉴스 URL을 입력해주세요. (예: https://www.bbc.com/business)",
                    invalid_rank_range: "잘못된 순위 범위입니다.",
                    ...
                    lemmyHelp: {
                        ...
                        period_filter: "🔧 기간: {timeFilter}{dateRange}",
                        reddit_collecting: "🔍 Reddit r/{boardName} - {sort} 정렬로 수집 중...",
                        blind_collecting: "🔍 Blind {boardName} 토픽 수집 중... ({sort})",
                        dcinside_collecting: "🔍 DCInside {boardName} 갤러리 수집 중... ({sort})",
                        bbc_starting: "🛡️ BBC 안정성 크롤러 시작...",
                        lemmy_starting: "🌐 Lemmy 크롤링 시작...",
                        universal_starting: "🔍 범용 크롤러 시작...",
                        translating_posts: "🌐 번역 처리 중...",
                        translating_details: "{count}개 게시물 번역",
                ...
                en: {
                    ...
                    // 에러 메시지들
                    invalid_bbc_url: "Please enter a valid BBC news URL. (e.g., https://www.bbc.com/business)",
                    invalid_rank_range: "Invalid rank range.",
                ...
                ja: {
                    ...
                    // エラーメッセージ
                    invalid_bbc_url: "有効なBBCニュースURLを入力してください。(例: https://www.bbc.com/business)",
                    invalid_rank_range: "無効なランク範囲です。",
                    no_posts_found: "投稿が見つかりませんでした。",
                    crawling_error: "クローリング中にエラーが発生しました: {error}",
                    ...
                    crawlingStatus: {
                        ...
                        period_filter: "🔧 期間: {timeFilter}{dateRange}",
                        reddit_collecting: "🔍 Reddit r/{boardName} - {sort}でソート中...",
                        dcinside_collecting: "🔍 DCInside {boardName} ギャラリー... ({sort})",
                        blind_collecting: "🔍 Blind {boardName} トピック... ({sort})",
                        bbc_starting: "🛡️ BBC安定クローラー開始中...",
                        lemmy_starting: "🌐 Lemmyクローリング開始中...",
                        universal_starting: "🔍 ユニバーサルクローラー開始中...",
                        translating_posts: "🌐 翻訳中...",
                        translating_details: "{count}件の投稿を翻訳中",
                    },
                    // 진행 단계별 메시지
                    progressSteps: {
